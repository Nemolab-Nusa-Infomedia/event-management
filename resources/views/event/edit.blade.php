...
@section('content')
        ...
        <a href="{{ route('events.preview.edit', ['event' => $event->id]) }}" class="inline-flex items-center mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
