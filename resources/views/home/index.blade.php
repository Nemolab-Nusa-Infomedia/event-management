                            ...
                            <tr class="border-b">
                                ...
                                <td class="py-3 px-4">
                                    ...
                                    @elseif ($item->event_date > now()->toDateString() || ($item->event_date == now()->toDateString() && $item->event_start > now()))
                                        <span class="px-2 py-1 bg-yellow-100 text-yellow-800 rounded-full text-xs font-semibold">Pendaftaran</span>
                                    @else
                                        <span class="px-2 py-1 bg-red-100 text-red-800 rounded-full text-xs font-semibold">Selesai</span>
                                    @endif
                                </td>
                                <td class="py-3 px-4">
                                    <button type="submit" class="flex items-center px-4 py-1 bg-green-500 text-white rounded hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50">
