...
<div class="container mx-auto p-4 sm:p-8 mb-4">  
    ...
    <h1 class="text-3xl sm:text-5xl dark:text-gray-200 font-bold text-gray-700 mb-8" data-aos="fade-right" data-aos-offset="100">{{ $event->name }}</h1>
...
<section id="info" class="container mx-auto p-4 sm:p-16 md:p-24 mb-4 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100" data-aos="fade-up" data-aos-offset="100">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div class="grid grid-cols-2 gap-2" data-aos="zoom-in" data-aos-offset="100">
            @php
                ...
                $placeholder = 'https://placehold.co/800x800/f3f4f6/000000/webp?text=Event+Image';
            @endphp
            
            @for ($i = 0; $i < 4; $i++)
                <img 
                    class="transform transition duration-300 hover:scale-105 object-cover h-[250px] sm:h-[200px] md:h-[250px] lg:h-[250px] w-[250px] sm:w-[200px] md:w-[250px] lg:w-[350px] rounded-lg border border-gray-300" 
