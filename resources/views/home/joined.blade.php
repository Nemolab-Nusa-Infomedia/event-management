...
@section('content')
            ...
            <tbody>
                @foreach ($event as $item)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <button data-modal-target="ticket-modal-{{ $item->id }}"
                                data-modal-toggle="ticket-modal-{{ $item->id }}"
                                data-qr-id="{{ $item->eventParticipants[0]->id }}"
    ...
    <!-- Ticket modal -->
    @foreach ($event as $item)
        <div id="ticket-modal-{{ $item->id }}" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button"
                            ...
                            data-modal-hide="ticket-modal-{{ $item->id }}" id="close-modal">
                    ...
                    <div class="flex items-center p-4 md:p-5 rounded-b">
                        <button data-modal-hide="ticket-modal-{{ $item->id }}" type="button"
