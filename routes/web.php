...
Route::resource('/admin',  Route::('/user') ? UsersController::class : (Route::has('/eventParticipan') ? EventParticipantsController::class : (Route::has('/event') ? EventsController::class : AdminController::class)))->middleware('auth');
